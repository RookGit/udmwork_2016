...
class AdsController
{
                                     ...
                                     $search_post = "all_search", $page_now = 1)
    {
        ...
        require_once(ROOT . '/models/get_ads/get_jobs.php');
        require_once(ROOT . '/views/ads/jobs.php');
        return true;
    }
                                       ...
                                       $page_now = 1)
    {
        ...
        require_once(ROOT . '/components/check_ads_post.php');
        require_once(ROOT . '/models/get_ads/get_resume.php');
        require_once(ROOT . '/views/ads/resume.php');
        return true;
    }
    ...
    {
        require_once(ROOT . '/components/check_ads_post.php');
        require_once(ROOT . '/models/get_ads/get_services.php');
        require_once(ROOT . '/views/ads/services.php');
        return true;
    }
    ...
    public function actionAbout($table_ads = "", $ads_id = 0)
    {
        ...
        require_once(ROOT . '/views/ads/about_' . $table_ads . '.php');
        return true;
    }


    public
    function actionEditAds($table_type = null, $id_ads = null)
    {
        $this->testTable($table_type);
        $this->testInteger($id_ads);
        require_once(ROOT . '/views/room/editing.php');
        return true;
    }
}
