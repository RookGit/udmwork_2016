...
<html lang="ru">
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        if($_POST['password_old_post'] != null and $_POST['password_new_post'] != null and $_POST['password_new_post_2'] != null)
        {
            ...
            if($result['pass'] != null)
            {
                if( $result['pass'] == $old_password_post)
                {
