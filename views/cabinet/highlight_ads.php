...
<html lang="ru">
  <head>
    ...
    <title>Выделение объявления | Работа, услуги в Ижевске и Удмуртской республике на UDMWORK.RU</title>
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        if(isset($result['header']))
        {
            if($agree == 0) 
                {
                    $message = "Вы точно хотите выделить объявление № ".$ads_id."?<br />"
                            . "(Заголовок: ".$result['header'].")<br />"
                            . "Это будет стоить 100 <img width='13' height='13' src='/template/images/сoin.png'/>";
                            
                    $message_array = array (
                        "Выделение объявления",
                        "$message",
                        "yellow",
                        "highlight/".$type_ads."/".$ads_id."/1",
                        "Да, точно",
                ...
                else
                {
                    ...
                    if( ($result_1['balance'] - 100) > -1)
                    {
                        ...
                        $query_2 = $db->prepare("UPDATE $type_ads SET color = :color WHERE id = :ads_id and author = :now_id;");
                        $params_2 = [
                            'color' => "ffff00",
                            'now_id' => $_SESSION['id'],
                            'ads_id' => $ads_id
                        ...
                        $message = "Объявление успешно выделено";
                        $message_array = array (
                        "Выделение объявления",
                        "$message",
                        "yellow",
