...
<head>
    ...
    <style>
        ...
        .post-tag2 a:hover:before {
            border-right-color: #444
        }

        .post-tag2 a:hover:after {
            transition: 0.2s linear;
            background-color: #fff;
            border-radius: 50%;
            content: "";
        ...
        <div class="content">
            ...
            <div class="col-xs-12 post-tag">
                ...
                foreach ($array_jobs as $value) {
                    ?>
                    <a rel="tag"
                       href="/jobs/all_city/all_time/all_type/time/<?= $value ?>/1"><?= $value ?></a>
                    <?php
                }
                ?>
            ...
            <div class="col-xs-12 post-tag2">
                ...
                foreach ($array_services as $value) {
                    ?>
                    <a rel="tag"
                       href="/services/all_city/all_time/all_type/time/<?= $value ?>/1"><?= $value ?></a>
                    <?php
                }
                ?>
            ...
            <div class="col-xs-12 post-tag3">
                ...
                foreach ($array_resume as $value) {
                    ?>
                    <a rel="tag"
                       href="/resume/all_city/all_time/all_type/time/<?= $value; ?>/1"><?= $value; ?></a>
                    <?php
                }
                ?>
            </div>
